...
<template>
  <IconLayout>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="currentColor" aria-hidden="true" class="dp__input_icon dp__input_icons fill-primary/50" role="img" aria-label="Calendar icon">
