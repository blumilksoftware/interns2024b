...
const props = defineProps<VisitOptions & { href:string, disabled?:boolean, useButtonStyle?:boolean, buttonClass?:string, small?:boolean, extraSmall?:boolean, text?:boolean }>()
...
<template>
  <Button
    ...
    :class="{ processing : 'cursor-wait' }"
    :extra-small :small :text
  >
    <slot />
  </Button>
  <button
