...
<template>
  ...
  >
      ...
      <div class="w-full">
        ...
        <div class="mt-2 w-full">
          <input
            ...
            name="name"
            type="text"
            :class="{'ring-red focus:ring-red':errors.name}"
      ...
      <div class="w-full">
        ...
        <div class="mt-2 w-full">
          <input
            ...
            name="surname"
            type="text"
            :class="{'ring-red focus:ring-red':errors.surname}"
            class="duration-200 ring-inset outline-none focus:ring focus:ring-primary bg-white/30 rounded-lg w-full p-3 text-gray-900 ring-2 ring-primary/30 placeholder:text-gray-400"
          >
    ...
    <div>
      ...
      <Searchbar
        :schools="schools"
        @change="school => form.school_id = school"
      />
    ...
    <div>
      ...
      <div class="mt-2">
        <input
          ...
          type="email"
          autocomplete="email"
          :class="{'ring-red focus:ring-red':errors.email}"
          class="duration-200 ring-inset outline-none focus:ring focus:ring-primary bg-white/30 rounded-lg w-full p-3 text-gray-900 ring-2 ring-primary/30 placeholder:text-gray-400"
        >
    ...
    <div>
      ...
      <div class="mt-2">
        <input
          ...
          :class="{'ring-red focus:ring-red':errors.password}"
          class="duration-200 ring-inset outline-none focus:ring focus:ring-primary bg-white/30 rounded-lg w-full p-3 text-gray-900 ring-2 ring-primary/30 placeholder:text-gray-400"
        >
